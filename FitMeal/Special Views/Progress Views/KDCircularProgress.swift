...
public class KDCircularProgress: UIView {
    ...
    public func animateFromAngle(fromAngle: Double, toAngle: Double, duration: NSTimeInterval, relativeDuration: Bool = false, completion: ((Bool) -> Void)?) {
        if isAnimating() {
            pauseAnimation()
        }
...
//    
//    public func continuousAnimate(fromAngle: Double, toAngle: Double, duration: NSTimeInterval, relativeDuration: Bool = true,stop:Bool,completion: ((Bool) -> Void)?) {
//        if isAnimating() {
//            pauseAnimation()
//        }
//        
...
//            animationCompletionBlock = completion
//        }else{
//            continuousAnimate(fromAngle, toAngle: toAngle, duration: duration,relativeDuration: relativeDuration,stop: stop)}
//    }
